<template>
    <view>
        <c-colors class="c-page-head" :class="{ 'c-page-head__fixed': fixed_ }" :pro="pro_"
                  :theme="theme_"
        >
            <c-status-bar />
            <view class="c-page-head__inner" :style="[ navbarInnerStyle_ ]">
                <view class="c-page-head-hd">
                    <c-icons v-if="back_" type="icon-tiaozhuan" :size="leftSize_"
                             :color="color" rotate="180" @click="$back"
                    />
        ...
        <view class="c-page-head__clear" :style="{height: navbarHeight_ + 'px'}"></view>
    </view>
</template>
