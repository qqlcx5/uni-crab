...
export default {
    ...
    methods: {
        ...
        async splitData() {
            ...
            // console.log(JSON.stringify(this.leftList), JSON.stringify(this.rightList))
            if (this.leftList.length === 0 && this.rightList.length === 0) {
                console.log('-------')
                this.leftList = this.tempList.filter((o, i) => i % 2 === 0)
                this.rightList = this.tempList.filter((o, i) => i % 2 === 1)
                this.tempList = []
                return
            }
