<template>
    <view class="c-checkbox" :style="[checkboxStyle]" @tap="onClickLabel">
        <view class="c-checkbox__icon-wrap" @tap.stop="toggle">
			<c-icons class="c-radio__icon-wrap__icon" :type="value ? 'icon-xuanzhong' : 'icon-weixuan'" :size="checkboxIconSize" :color="iconColor"/>
        </view>
        <view class="c-checkbox__label" v-if="$slots.default" :style="{ fontSize: addUnit(labelSize),flex: this.parent.wrap ? 1 : 'auto' }">
            <slot />
        </view>
    </view>
</template>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.parent = this.getParent('c-checkbox-group');
        ...
        computed: {
            ...
            iconStyle() {
                ...
                style.width = this.addUnit(this.checkboxSize);
                style.height = this.addUnit(this.checkboxSize);
                return style;
            },
