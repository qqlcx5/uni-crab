<template>
	<view class="c-cell-group" :style="[ groupStyle ]">
		<view class="c-cell-group__title" v-if="title" :style="[ titleStyle ]">
			{{title}}
		</view>
		<view class="c-cell-group__content" :class="{'c-underline c-underline__top': border_}">
			<slot />
		</view>
	</view>
</template>
